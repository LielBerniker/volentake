...
public class FeedPostsVolShuffle extends AppCompatActivity {

    private RecyclerView recyclePostsVolShuffle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feed_posts_vol_shuffle);
        backBtn = findViewById(R.id.back_activity_feed_posts_vol_shuffle);
        ...
        recyclePostsVolShuffle = findViewById(R.id.recyclePostsVolShuffle);
        ...
        mRootRef.child("posts")
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            builder.setTitle("volunteering events")
                                    ...
                                    .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            Intent intent1 = new Intent(FeedPostsVolShuffle.this, MainSearchPostsVol.class);
                        ...
                        recyclePostsVolShuffle.setLayoutManager(new GridLayoutManager(FeedPostsVolShuffle.this, 1));
                        progressDialog.dismiss();
                    }
        ...
        backBtn.setOnClickListener(view -> {
            Intent intent = new Intent(FeedPostsVolShuffle.this, MainSearchPostsVol.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itembacktouser:
                Intent intent1 = new Intent(FeedPostsVolShuffle.this,VolunteerPage.class);
                intent1.putExtra("id",vol_user_id);
                startActivity(intent1);
                return true;
            case R.id.itemlogout:
                builder.setTitle("log out")
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent1 = new Intent(FeedPostsVolShuffle.this, VolunteerLogIn.class);
                                startActivity(intent1);
                            }
                        })
