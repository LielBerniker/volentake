...
public class picture_edit_vol extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picture_edit_vol);
                    ...
                    .addOnSuccessListener(
                            new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                        ...
                                        UploadTask.TaskSnapshot taskSnapshot)
                                {
                                    ...
                                    Toast
                                            .makeText(picture_edit_vol.this,
                                                    "Image Uploaded!!",
                                                    Toast.LENGTH_SHORT)
                                            .show();
                                    Intent intent1 = new Intent(picture_edit_vol.this, VolunteerPage.class);
                ...
                builder.setTitle("log out")
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent1 = new Intent(picture_edit_vol.this, VolunteerLogIn.class);
                                startActivity(intent1);
                            }
                        })
